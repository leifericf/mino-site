    ...
    (h/html
      ...
      [:ul
       ...
       [:li [:strong "5 host arches with on-disk byte tables."]
        ...
        [:ul
         [:li [:code "stencils_arm64_darwin.h"] " (90,568 bytes)"]
         [:li [:code "stencils_arm64_linux.h"] " (90,782 bytes)"]
         [:li [:code "stencils_x86_64_darwin.h"] " (84,925 bytes)"]
         [:li [:code "stencils_x86_64_linux.h"] " (84,396 bytes)"]
         [:li [:code "stencils_x86_64_windows.h"] " (87,195 bytes)"]]]
