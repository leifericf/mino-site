...
(function() {
  ...
  function hlC(code) {
    ...
    code = code.replace(/\\b(mino_val|mino_env|mino_repl|mino_state|mino_future|mino_root|mino_type|mino_iter|mino_vec_builder|mino_map_builder|mino_set_builder|mino_diag|mino_gc_kind|mino_gc_param|mino_gc_stats_out|mino_jit_mode|mino_jit_capability|mino_thread_pool|mino_capability_info|mino_reg|mino_prim_fn|mino_prim_fn2|mino_finalizer_fn|mino_host_fn|mino_resolve_fn|mino_tx_xform_fn|mino_tx_body_fn|mino_thread_lifecycle_fn|mino_vec_node_t|mino_hamt_node_t|size_t|FILE)\\b/g,
